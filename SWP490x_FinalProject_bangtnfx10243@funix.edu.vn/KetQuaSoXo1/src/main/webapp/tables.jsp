	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Tổng Quản</span></a>
			</li>
			<!-- Divider -->
			...
			<li class="nav-item active"><a class="nav-link"
				href="${pageContext.request.contextPath}/manageKQSX.jsp"> <i class="fas fa-fw fa-cog"></i> <span>Quản Lý KQSX</span></a>
			</li>
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#collapseTwo"
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-cog"></i><span>Thêm KQSX</span></a></li>
			...
			<!-- Nav Item - Pages Collapse Menu -->
			<li class="nav-item active"><a class="nav-link"
				href="index.html"> <i class="fas fa-fw fa-cog"></i> <span>Quản Lý NGười Dùng</span></a>
			</li>
			<!-- Divider -->
						...
						<div class="card-body">
							<div class="table-responsive">
								<div class="d-grid gap-2 d-md-flex justify-content-md-end">
									<div class="dropdown">
										<button class="btn btn-primary me-md-2  dropdown-toggle "
											id="navbarDropdown" role="button" data-bs-toggle="dropdown"
											aria-expanded="false">Vùng</button>
									...
									<form action="${pageContext.request.contextPath}/test"
										...
										<div class="mess" id="xoa">
											<div class="thongbao">
												...
												<input value="Xóa" type="submit" class="btn btn-primary">
												<input value="Hủy" type="button" class="btn btn-primary"
													id="huy">
											</div>
										</div>
											...
											<table class="table table-bordered">
												...
												<tr>
													...
													<td>
														...
														<form
															action="${pageContext.request.contextPath}/update.jsp">
...
if (mess != null) {%>
		$(document).ready(function() { $("#mess").show();
		$("#oke").click(function() { $("#mess").toggle(); }); });
		<%}%>
